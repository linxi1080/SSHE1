...
<%@page import="lh.util.document.DocConverter"%>
<%
	...
	//new MultipartRequest(request, fileDir.getAbsolutePath(), inmaxPostSize, "UTF-8", myRenamePolicyCos);
...
<body>
	<div>
		<form name="viewForm" id="form_swf" action="documentView.jsp"
			method="POST">
