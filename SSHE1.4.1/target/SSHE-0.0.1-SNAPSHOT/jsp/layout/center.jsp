...
<script type="text/javascript">
	$(function(){
		...
		tabRigthMenuEven('jsp_layout_center_tabs','jsp_layout_center_tabsRigthMenu');
	});
</script>
<div id="jsp_layout_center_tabs" class="easyui-tabs" data-options="fit:true,border:true">
	<div title="主页" data-options="iconCls:'exticon-home'">
		<div class="cs-home-remark">
			<script type="text/javascript">
				$(function() {
					...
					tabs.tabs('add',{
						title:'测试',
						href:'${pageContext.request.contextPath}/jsp/admin/role.jsp',
						closable:true,
						iconCls:'icon-edit'
					});
					*/
...
<!--tab页右键菜单-->
<div id="jsp_layout_center_tabsRigthMenu" class="easyui-menu cs-tab-menu">
